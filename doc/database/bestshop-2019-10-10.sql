...
-- ----------------------------
INSERT INTO `yoshop_category` VALUES (1, 'test', 0, 0, 100, 10001, 1566543777, 1566543777);
INSERT INTO `yoshop_category` VALUES (2, 'teste', 0, 1, 100, 10001, 1569681034, 1569681034);
...
-- ----------------------------
INSERT INTO `yoshop_delivery` VALUES (1, 'test1', 10, 100, 10001, 1566543884, 1566543884);
INSERT INTO `yoshop_delivery` VALUES (2, 'testswt', 10, 100, 10001, 1569742092, 1569742092);
...
-- ----------------------------
INSERT INTO `yoshop_delivery_rule` VALUES (1, 1, '2', 1, 10.00, 0, 10.00, 10001, 1566543884);
INSERT INTO `yoshop_delivery_rule` VALUES (2, 2, '2', 1, 0.00, 0, 0.00, 10001, 1569742092);
...
-- ----------------------------
-- Table structure for yoshop_distributors_users
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_distributors_users`;
CREATE TABLE `yoshop_distributors_users`  (
  `user_id` int(11) NOT NULL AUTO_INCREMENT,
  `wx_image_url` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `wx_nickname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `phone` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `total_commission` decimal(18, 5) NULL DEFAULT NULL COMMENT '总佣金',
  `withdrawalable` decimal(18, 5) NULL DEFAULT NULL COMMENT '可体现佣金',
  `referrer_apps_user_id` int(11) NULL DEFAULT NULL,
  `parent_user_id` int(11) NULL DEFAULT NULL COMMENT '父级id',
  `create_time` int(11) NULL DEFAULT NULL COMMENT '申请时间',
  `update_time` int(11) NULL DEFAULT NULL COMMENT '更新时间',
  `processing_time` int(11) NULL DEFAULT NULL COMMENT '审核时间',
...
-- ----------------------------
-- Table structure for yoshop_distributors_withdrawal
-- ----------------------------
DROP TABLE IF EXISTS `yoshop_distributors_withdrawal`;
CREATE TABLE `yoshop_distributors_withdrawal`  (
  `id` int(11) NOT NULL,
  `distributors_users_id` int(11) NULL DEFAULT NULL,
  `amount` decimal(18, 0) NULL DEFAULT NULL,
  `withdrawal_way` int(2) NULL DEFAULT NULL,
  `comment` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `status` int(2) NULL DEFAULT 0,
  `create_time` int(11) NULL DEFAULT NULL,
  `processing_time` int(11) NULL DEFAULT NULL,
  `op_user_id` int(11) NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `yoshop_goods` VALUES (1, 'test01', 1, 10, 10, '&lt;p&gt;234324es dfdfdgdfgfdg&lt;/p&gt;', 0, 0, 100, 1, 10, 0, 10001, 1566543902, 1570515762);
INSERT INTO `yoshop_goods` VALUES (2, 'tets', 1, 10, 10, '&lt;p&gt;23423423234&lt;/p&gt;', 123, 0, 100, 1, 20, 0, 10001, 1569681063, 1570515748);
...
-- ----------------------------
INSERT INTO `yoshop_goods_image` VALUES (3, 2, 2, 10001, 1570515748);
INSERT INTO `yoshop_goods_image` VALUES (4, 1, 2, 10001, 1570515762);
...
-- ----------------------------
INSERT INTO `yoshop_goods_spec` VALUES (3, 2, 'sdfds', 234.00, 32423.00, 234, 0, 234, 10001, '', 1570515748, 1570515748);
INSERT INTO `yoshop_goods_spec` VALUES (4, 1, 'fdgdfgdf', 23432.00, 32432.00, 34, 0, 234, 10001, '', 1570515762, 1570515762);
...
-- ----------------------------
INSERT INTO `yoshop_setting` VALUES ('sms', '短信通知', '{\"default\":\"aliyun\",\"engine\":{\"aliyun\":{\"AccessKeyId\":\"23432\",\"AccessKeySecret\":\"23423\",\"sign\":\"23432\",\"order_pay\":{\"is_enable\":\"1\",\"template_code\":\"SMS_139800030\",\"accept_phone\":\"1234662222\"}}}}', 10001, 1569742120);
...
INSERT INTO `yoshop_setting` VALUES ('store', '商城设置', '{\"name\":\"my shop\"}', 10001, 1570503681);
...
-- ----------------------------
INSERT INTO `yoshop_store_user` VALUES (10001, 'admin', 'a07ca13888ed4495d1fb59939f263a65', 10001, 1529926348, 1531027042);
...
-- ----------------------------
INSERT INTO `yoshop_upload_file` VALUES (1, 'local', 0, '', '20190823150233acc154348.jpg', 26646, 'image', 'jpg', 1, 10001, 1566543763);
INSERT INTO `yoshop_upload_file` VALUES (2, 'local', 0, '', '20191008142222550ee6118.jpg', 63673, 'image', 'jpg', 0, 10001, 1570515742);
INSERT INTO `yoshop_upload_file` VALUES (3, 'local', 0, '', '20191008142337b25767762.jpg', 251187, 'image', 'jpg', 0, 10001, 1570515817);
...
CREATE TABLE `yoshop_wxapp`  (
  ...
  `phone_no` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '电话号码',
...
-- ----------------------------
INSERT INTO `yoshop_wxapp` VALUES (10001, '萤火小程序商城', 'fdsf', 'dsfdsfds', 0, 0, 0, '', 0, 'fdsfdsf', 'dsfdsf', 1529926348, 1566543929);
...
-- ----------------------------
INSERT INTO `yoshop_wxapp_page` VALUES (10001, 10, '{\"items\":{\"s10001\":{\"id\":\"s10001\",\"type\":\"search\",\"params\":{\"placeholder\":\"\\u641c\\u7d22\\u5546\\u54c1\"},\"style\":{\"textAlign\":\"center\",\"searchStyle\":\"radius\"}},\"n606196612728596\":{\"id\":\"n606196612728596\",\"type\":\"banner\",\"style\":{\"btnColor\":\"#ffffff\",\"btnShape\":\"round\"},\"data\":{\"n400199453786769\":{\"imgUrl\":\"http:\\/\\/www.bestshop.com\\/uploads\\/20191008142337b25767762.jpg\",\"imgName\":\"http:\\/\\/www.bestshop.com\\/uploads\\/20191008142337b25767762.jpg\",\"linkUrl\":\"\"},\"n837367626101537\":{\"imgUrl\":\"http:\\/\\/www.bestshop.com\\/uploads\\/20191008142337b25767762.jpg\",\"imgName\":\"http:\\/\\/www.bestshop.com\\/uploads\\/20191008142337b25767762.jpg\",\"linkUrl\":\"\"}}},\"n131097532627373\":{\"id\":\"n131097532627373\",\"type\":\"search\",\"params\":{\"placeholder\":\"\\u8bf7\\u8f93\\u5165\\u5173\\u952e\\u5b57\\u8fdb\\u884c\\u641c\\u7d22\"},\"style\":{\"textAlign\":\"left\",\"searchStyle\":\"\"}}}}', 10001, 1529926348, 1570515829);
