...
# Database: bestshop
# Generation Time: 2019-10-15 07:31:54 +0000
# ************************************************************
...
INSERT INTO `yoshop_category` (`category_id`, `name`, `parent_id`, `image_id`, `sort`, `wxapp_id`, `create_time`, `update_time`)
VALUES
	(1,'test',0,0,100,10001,1566543777,1566543777),
	(2,'teste',0,1,100,10001,1569681034,1569681034);

/*!40000 ALTER TABLE `yoshop_category` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_delivery
# ------------------------------------------------------------
...
INSERT INTO `yoshop_delivery` (`delivery_id`, `name`, `method`, `sort`, `wxapp_id`, `create_time`, `update_time`)
VALUES
	(1,'test1',10,100,10001,1566543884,1566543884),
	(2,'testswt',10,100,10001,1569742092,1569742092);

/*!40000 ALTER TABLE `yoshop_delivery` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_delivery_rule
# ------------------------------------------------------------
...
INSERT INTO `yoshop_delivery_rule` (`rule_id`, `delivery_id`, `region`, `first`, `first_fee`, `additional`, `additional_fee`, `wxapp_id`, `create_time`)
VALUES
	(1,1,'2',1,10.00,0,10.00,10001,1566543884),
	(2,2,'2',1,0.00,0,0.00,10001,1569742092);

/*!40000 ALTER TABLE `yoshop_delivery_rule` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_dictionary
# ------------------------------------------------------------
...
# Dump of table yoshop_distributors_commission
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yoshop_distributors_commission`;
...
# Dump of table yoshop_distributors_setting
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yoshop_distributors_setting`;
...
CREATE TABLE `yoshop_distributors_setting` (
  ...
  `value` text NOT NULL COMMENT 'json 格式存储',
  `wxapp_id` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '小程序id',
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  PRIMARY KEY (`id`)
...
LOCK TABLES `yoshop_distributors_setting` WRITE;
/*!40000 ALTER TABLE `yoshop_distributors_setting` DISABLE KEYS */;

INSERT INTO `yoshop_distributors_setting` (`id`, `key`, `value`, `wxapp_id`, `create_time`, `update_time`)
VALUES
	(1,'template_msg','{\"apply_tpl\":\"drtr\",\"withdraw_tpl\":\"retret\"}',10001,1570882936,1571067381),
	(2,'background','{\"__\":\"\",\"index\":\"https:\\/\\/demo.yiovo.com\\/assets\\/api\\/dealer-bg.png\",\"apply\":\"https:\\/\\/demo.yiovo.com\\/assets\\/api\\/dealer-bg.png\",\"withdraw_apply\":\"https:\\/\\/demo.yiovo.com\\/assets\\/api\\/dealer-bg.png\"}',10001,1570883028,1571067381),
	(3,'license','{\"license\":\"wdsfdgdfgfdgfdhdfhdf\"}',10001,1571013673,1571067381),
	(4,'words','{\"index\":{\"title\":{\"value\":\"\\u5206\\u9500\\u4e2d\\u5fc31\"},\"words\":{\"not_dealer\":{\"value\":\"\\u60a8\\u8fd8\\u4e0d\\u662f\\u5206\\u9500\\u5546\\uff0c\\u8bf7\\u5148\\u63d0\\u4ea4\\u7533\\u8bf72\"},\"apply_now\":{\"value\":\"\\u7acb\\u5373\\u52a0\\u51653\"},\"referee\":{\"value\":\"\\u63a8\\u8350\\u4eba4\"},\"money\":{\"value\":\"\\u53ef\\u63d0\\u73b05\"},\"freeze_money\":{\"value\":\"\\u5f85\\u63d0\\u73b06\"},\"total_money\":{\"value\":\"\\u5df2\\u63d0\\u73b0\\u91d1\\u989d7\"},\"withdraw\":{\"value\":\"\\u53bb\\u63d0\\u73b08\"}}},\"apply\":{\"title\":{\"value\":\"\\u7533\\u8bf7\\u6210\\u4e3a\\u5206\\u9500\\u55469\"},\"words\":{\"title\":{\"value\":\"\\u8bf7\\u586b\\u5199\\u7533\\u8bf7\\u4fe1\\u606f10\"},\"license\":{\"value\":\"\\u5206\\u9500\\u5546\\u7533\\u8bf7\\u534f\\u8bae11\"},\"submit\":{\"value\":\"\\u7533\\u8bf7\\u6210\\u4e3a\\u7ecf\\u9500\\u554612\"},\"wait_audit\":{\"value\":\"\\u60a8\\u7684\\u7533\\u8bf7\\u5df2\\u53d7\\u7406\\uff0c\\u6b63\\u5728\\u8fdb\\u884c\\u4fe1\\u606f\\u6838\\u9a8c\\uff0c\\u8bf7\\u8010\\u5fc3\\u7b49\\u5f85\\u300213\"},\"goto_mall\":{\"value\":\"\\u53bb\\u5546\\u57ce\\u901b\\u901b14\"}}},\"order\":{\"title\":{\"value\":\"\\u5206\\u9500\\u8ba2\\u535515\"},\"words\":{\"all\":{\"value\":\"\\u5168\\u90e816\"},\"unsettled\":{\"value\":\"\\u672a\\u7ed3\\u7b9717\"},\"settled\":{\"value\":\"\\u5df2\\u7ed3\\u7b9718\"}}},\"team\":{\"title\":{\"value\":\"\\u6211\\u7684\\u56e2\\u961f19\"},\"words\":{\"total_team\":{\"value\":\"\\u56e2\\u961f\\u603b\\u4eba\\u657020\"},\"first\":{\"value\":\"\\u4e00\\u7ea7\\u56e2\\u961f21\"},\"second\":{\"value\":\"\\u4e8c\\u7ea7\\u56e2\\u961f22\"},\"third\":{\"value\":\"\\u4e09\\u7ea7\\u56e2\\u961f23\"}}},\"withdraw_list\":{\"title\":{\"value\":\"\\u63d0\\u73b0\\u660e\\u7ec624\"},\"words\":{\"all\":{\"value\":\"\\u5168\\u90e825\"},\"apply_10\":{\"value\":\"\\u5ba1\\u6838\\u4e2d26\"},\"apply_20\":{\"value\":\"\\u5ba1\\u6838\\u901a\\u8fc727\"},\"apply_40\":{\"value\":\"\\u5df2\\u6253\\u6b3e28\"},\"apply_30\":{\"value\":\"\\u9a73\\u56de29\"}}},\"withdraw_apply\":{\"title\":{\"value\":\"\\u7533\\u8bf7\\u63d0\\u73b030\"},\"words\":{\"capital\":{\"value\":\"\\u53ef\\u63d0\\u73b0\\u4f63\\u91d131\"},\"money\":{\"value\":\"\\u63d0\\u73b0\\u91d1\\u989d32\"},\"money_placeholder\":{\"value\":\"\\u8bf7\\u8f93\\u5165\\u8981\\u63d0\\u53d6\\u7684\\u91d1\\u989d33\"},\"min_money\":{\"value\":\"\\u6700\\u4f4e\\u63d0\\u73b0\\u4f63\\u91d135\"},\"submit\":{\"value\":\"36\"}}},\"qrcode\":{\"title\":{\"value\":\"\\u63a8\\u5e7f\\u4e8c\\u7ef4\\u780137\"}}}',10001,1571013686,1571067381),
	(5,'settlement','{\"pay_type\":[\"10\",\"20\",\"30\"],\"min_money\":\"10.00\",\"settle_days\":\"10\"}',10001,1571013727,1571067381),
	(6,'commission','{\"first_money\":\"0\",\"second_money\":\"0\",\"third_money\":\"0\"}',10001,1571013733,1571067381),
	(7,'condition','{\"become\":\"20\",\"become__buy_goods\":\"0\",\"downline\":\"10\"}',10001,1571013740,1571067381),
	(8,'basic','{\"is_open\":\"1\",\"level\":\"2\",\"self_buy\":\"0\"}',10001,1571013869,1571067381),
	(9,'qrcode','',10001,1571106775,1571106800);

/*!40000 ALTER TABLE `yoshop_distributors_setting` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_distributors_users
# ------------------------------------------------------------
...
CREATE TABLE `yoshop_distributors_users` (
  ...
  `wx_image_url` varchar(255) DEFAULT NULL,
  `wx_nickname` varchar(255) DEFAULT NULL,
  `username` varchar(255) DEFAULT NULL,
  `phone` varchar(255) DEFAULT NULL,
  `total_commission` decimal(18,5) DEFAULT NULL COMMENT '总佣金',
  `withdrawalable` decimal(18,5) DEFAULT NULL COMMENT '可体现佣金',
  `referrer_apps_user_id` int(11) DEFAULT NULL,
  `parent_user_id` int(11) DEFAULT NULL COMMENT '父级id',
  `create_time` int(11) DEFAULT NULL COMMENT '申请时间',
  `update_time` int(11) DEFAULT NULL COMMENT '更新时间',
  `processing_time` int(11) DEFAULT NULL COMMENT '审核时间',
...
# Dump of table yoshop_distributors_withdrawal
# ------------------------------------------------------------
...
CREATE TABLE `yoshop_distributors_withdrawal` (
  `id` int(11) NOT NULL,
  `distributors_users_id` int(11) DEFAULT NULL,
  `amount` decimal(18,0) DEFAULT NULL,
  `withdrawal_way` int(2) DEFAULT NULL,
...
INSERT INTO `yoshop_goods` (`goods_id`, `goods_name`, `category_id`, `spec_type`, `deduct_stock_type`, `content`, `sales_initial`, `sales_actual`, `goods_sort`, `delivery_id`, `goods_status`, `is_delete`, `wxapp_id`, `create_time`, `update_time`)
VALUES
	(1,'test01',1,10,10,'&lt;p&gt;234324es dfdfdgdfgfdg&lt;/p&gt;',0,0,100,1,10,0,10001,1566543902,1570515762),
	(2,'tets',1,10,10,'&lt;p&gt;23423423234&lt;/p&gt;',123,0,100,1,20,0,10001,1569681063,1570515748);

/*!40000 ALTER TABLE `yoshop_goods` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_goods_image
# ------------------------------------------------------------
...
INSERT INTO `yoshop_goods_image` (`id`, `goods_id`, `image_id`, `wxapp_id`, `create_time`)
VALUES
	(3,2,2,10001,1570515748),
	(4,1,2,10001,1570515762);

/*!40000 ALTER TABLE `yoshop_goods_image` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_goods_spec
# ------------------------------------------------------------
...
LOCK TABLES `yoshop_goods_spec` WRITE;
/*!40000 ALTER TABLE `yoshop_goods_spec` DISABLE KEYS */;

INSERT INTO `yoshop_goods_spec` (`goods_spec_id`, `goods_id`, `goods_no`, `goods_price`, `line_price`, `stock_num`, `goods_sales`, `goods_weight`, `wxapp_id`, `spec_sku_id`, `create_time`, `update_time`)
VALUES
	(3,2,'sdfds',234.00,32423.00,234,0,234,10001,'',1570515748,1570515748),
	(4,1,'fdgdfgdf',23432.00,32432.00,34,0,234,10001,'',1570515762,1570515762);

/*!40000 ALTER TABLE `yoshop_goods_spec` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_goods_spec_rel
# ------------------------------------------------------------
...
# Dump of table yoshop_order_address
# ------------------------------------------------------------
...
# Dump of table yoshop_order_goods
# ------------------------------------------------------------
...
INSERT INTO `yoshop_region` (`id`, `pid`, `shortname`, `name`, `merger_name`, `level`, `pinyin`, `code`, `zip_code`, `first`, `lng`, `lat`)
VALUES
...
INSERT INTO `yoshop_setting` (`key`, `describe`, `values`, `wxapp_id`, `update_time`)
VALUES
	('sms','短信通知','{\"default\":\"aliyun\",\"engine\":{\"aliyun\":{\"AccessKeyId\":\"23432\",\"AccessKeySecret\":\"23423\",\"sign\":\"23432\",\"order_pay\":{\"is_enable\":\"1\",\"template_code\":\"SMS_139800030\",\"accept_phone\":\"1234662222\"}}}}',10001,1569742120),
	('storage','上传设置','{\"default\":\"local\",\"engine\":{\"qiniu\":{\"bucket\":\"\",\"access_key\":\"\",\"secret_key\":\"\",\"domain\":\"\"}}}',10001,1529926348),
	('store','商城设置','{\"name\":\"my shop\"}',10001,1570503681),
...
# Dump of table yoshop_sharing_active_orders
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yoshop_sharing_active_orders`;

CREATE TABLE `yoshop_sharing_active_orders` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT 'id',
  `active_id` int(11) unsigned NOT NULL COMMENT '活动id',
  `order_id` int(11) unsigned NOT NULL COMMENT '订单id',
...
# Dump of table yoshop_sharing_actives
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yoshop_sharing_actives`;
...
# Dump of table yoshop_sharing_comments
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yoshop_sharing_comments`;
...
CREATE TABLE `yoshop_sharing_comments` (
  ...
  `images` varchar(255) DEFAULT NULL COMMENT '图片路径，json存储',
...
# Dump of table yoshop_sharing_goods
# ------------------------------------------------------------
...
# Dump of table yoshop_sharing_goods_image
# ------------------------------------------------------------
...
# Dump of table yoshop_sharing_goods_spec
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yoshop_sharing_goods_spec`;
...
# Dump of table yoshop_sharing_goods_spec_rel
# ------------------------------------------------------------
...
# Dump of table yoshop_sharing_orders
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yoshop_sharing_orders`;
...
# Dump of table yoshop_sharing_refunds
# ------------------------------------------------------------

DROP TABLE IF EXISTS `yoshop_sharing_refunds`;
...
# Dump of table yoshop_spec_value
# ------------------------------------------------------------
...
# Dump of table yoshop_store_user
# ------------------------------------------------------------
...
INSERT INTO `yoshop_store_user` (`store_user_id`, `user_name`, `password`, `wxapp_id`, `create_time`, `update_time`)
VALUES
	(10001,'admin','a07ca13888ed4495d1fb59939f263a65',10001,1529926348,1531027042);

/*!40000 ALTER TABLE `yoshop_store_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_upload_file
# ------------------------------------------------------------
...
INSERT INTO `yoshop_upload_file` (`file_id`, `storage`, `group_id`, `file_url`, `file_name`, `file_size`, `file_type`, `extension`, `is_delete`, `wxapp_id`, `create_time`)
VALUES
	(1,'local',0,'','20190823150233acc154348.jpg',26646,'image','jpg',1,10001,1566543763),
	(2,'local',0,'','20191008142222550ee6118.jpg',63673,'image','jpg',0,10001,1570515742),
	(3,'local',0,'','20191008142337b25767762.jpg',251187,'image','jpg',0,10001,1570515817);

/*!40000 ALTER TABLE `yoshop_upload_file` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_upload_group
# ------------------------------------------------------------
...
# Dump of table yoshop_user_address
# ------------------------------------------------------------
...
INSERT INTO `yoshop_wxapp` (`wxapp_id`, `app_name`, `app_id`, `app_secret`, `is_service`, `service_image_id`, `is_phone`, `phone_no`, `phone_image_id`, `mchid`, `apikey`, `create_time`, `update_time`)
VALUES
	(10001,'萤火小程序商城','fdsf','dsfdsfds',0,0,0,'',0,'fdsfdsf','dsfdsf',1529926348,1566543929);

/*!40000 ALTER TABLE `yoshop_wxapp` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_wxapp_help
# ------------------------------------------------------------
...
INSERT INTO `yoshop_wxapp_help` (`help_id`, `title`, `content`, `sort`, `wxapp_id`, `create_time`, `update_time`)
VALUES
...
# Dump of table yoshop_wxapp_navbar
# ------------------------------------------------------------
...
LOCK TABLES `yoshop_wxapp_navbar` WRITE;
/*!40000 ALTER TABLE `yoshop_wxapp_navbar` DISABLE KEYS */;

INSERT INTO `yoshop_wxapp_navbar` (`wxapp_id`, `wxapp_title`, `top_text_color`, `top_background_color`, `create_time`, `update_time`)
VALUES
	(10001,'萤火小程序商城',20,'#00a92c',1529926348,1529936495);

/*!40000 ALTER TABLE `yoshop_wxapp_navbar` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table yoshop_wxapp_page
# ------------------------------------------------------------
...
INSERT INTO `yoshop_wxapp_page` (`page_id`, `page_type`, `page_data`, `wxapp_id`, `create_time`, `update_time`)
VALUES
