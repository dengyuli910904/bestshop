            ...
            <div class="widget am-cf">
                ...
                <div class="widget-body am-fr">
                    ...
                    <div class="page_toolbar am-margin-bottom-xs am-cf">
                        <form class="toolbar-form" action="<?= url('/store/apps.dealer.user/index') ?>">
                            <input type="hidden" name="s" value="/store/apps.dealer.user/index">
                         ...
                         tpl-table-black am-text-nowrap">
                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle"><?= $item['total_commission'] ?><br/><?= $item['withdrawalable'] ?></td>
                                    <td class="am-text-middle"><?= $item['referrer_apps_user_id'] ?></td>
                                    <td class="am-text-middle"><?= $item['parent_user_id'] ?></td>
<!--                                    <td class="am-text-middle">-->
...
<!--                                            </span>-->
<!--                                    </td>-->
                                    <td class="am-text-middle"><?= $item['processing_time'] ?></td>
                                    <td class="am-text-middle">
