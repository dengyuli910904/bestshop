    ...
    <div class="row-content am-cf">
        <div class="widget am-cf">
            <div class="widget-body">
                <!-- diy 工作区 -->
                <div id="app" class="work-diy dis-flex flex-x-between"><div id="diy-menu" class="diy-menu"><div class="menu-title"><span>组件库</span></div> <div class="navs"><div class="navs-group"><div class="title">媒体组件</div> <div class="navs-components am-cf"><nav class="special"><p class="item-icon"><i class="iconfont icon-tupianlunbo"></i></p> <p>图片轮播</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-tupian1"></i></p> <p>单图组</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-newbilayout"></i></p> <p>图片橱窗</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-shipin7"></i></p> <p>视频组</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-zixun"></i></p> <p>文章组</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-toutiao"></i></p> <p>头条快报</p></nav></div> <div class="title">商城组件</div> <div class="navs-components am-cf"><nav class="special"><p class="item-icon"><i class="iconfont icon-wxbsousuotuiguang"></i></p> <p>搜索框</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-gonggao"></i></p> <p>公告组</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-daohang"></i></p> <p>导航组</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-shangpin5"></i></p> <p>商品组</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-youhuiquan2"></i></p> <p>优惠券组</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-shangpin5"></i></p> <p>拼团商品</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-kanjia"></i></p> <p>砍价商品</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-mendian"></i></p> <p>线下门店</p></nav></div> <div class="title">工具组件</div> <div class="navs-components am-cf"><nav class="special"><p class="item-icon"><i class="iconfont icon-kefu"></i></p> <p>在线客服</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-wenbenbianji"></i></p> <p>富文本</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-kongbai"></i></p> <p>辅助空白</p></nav> <nav class="special"><p class="item-icon"><i class="iconfont icon-fengexian1"></i></p> <p>辅助线</p></nav></div></div></div> <div class="action"><button type="button" class="am-btn am-btn-xs am-btn-secondary">
                                保存页面
                            </button></div></div> <div class="diy-phone"><div id="diy-page" class="phone-top optional" style="background: url(&quot;assets/store/img/diy/phone-top-black.png&quot;) center center / contain no-repeat rgb(255, 255, 255);"><h4 style="color: black;">页面标题</h4></div> <div id="phone-main" class="phone-main"><div class="dragArea"></div></div></div> <div id="diy-editor" class="diy-editor form-horizontal" style="visibility: hidden;"><!----> <!----></div></div>
                <!-- 提示 -->
        ...
        $(function () {
            ...
            new diyPhone({
                ...
                "service":{"name":"\u5728\u7ebf\u5ba2\u670d","type":"service",
                    ...
                    "style":{"right":"1","bottom":"10","opacity":"100"}}}, {"page":{"type":"page","name":"\u9875\u9762\u8bbe\u7f6e",
